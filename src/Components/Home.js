...
function Home() {
  ...
  return (
    ...
    <div className="home">
      ...
      <h4>
        You have been assigned to deliver a package with a beeping sound,<h5>To one of my closest <strong>"friends"</strong> who lives in the tallest
        skyscraper in the World and works for our top competetors, but I don't know which floor.</h5>
      </h4>
